...
public class Mp4VideoUtil extends VideoUtil {
    ...
    //清除已生成的mp4
    private static void clear_mp4(String mp4_path){
        //删除原来已经生成的m3u8及ts文件
...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        //ffmpeg的路径
        String ffmpeg_path = "D:\\Program Files\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "D:\\生活\\学习\\西电杭研院\\代码库\\java\\项目\\已完成\\学成在线\\上传文件\\video\\1.avi";
        //转换后mp4文件的名称
        String mp4_name = "";
        //转换后mp4文件的路径
        String mp4_path = "D:\\生活\\学习\\西电杭研院\\代码库\\java\\项目\\已完成\\学成在线\\上传文件\\video\\zh.mp4";
        //创建工具类对象
